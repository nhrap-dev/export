...
import hazpy
name = 'fl_test_udf'
sr = hazpy.legacy.StudyRegion(name)
sr.report.save('C:/Users/jrainesi/Downloads/1_export/'+name+'.pdf', premade=sr.hazard)

sr.hazard = sr.hazards[1]
sr.getHazardsAnalyzed()
sr.getResults()
sr.getBuildingDamageByType()
sr.getEconomicLoss()
"""
